...
class MBConvBlock(tf.keras.layers.Layer):
    ...
    def _build(self):
        ...
        get_norm_name = lambda: "tpu_batch_normalization" + (
...
class EffNetV2Model(tf.keras.Model):
    ...
    def __init__(self, model_name="efficientnetv2-s", model_config=None, name=None):
    ...
    def _build(self):
        ...
        for block_args in self._mconfig.blocks_args:
            ...
            repeats = round_repeats(
                block_args.num_repeat, self._mconfig.depth_coefficient
            )
            block_args.update(
                dict(
